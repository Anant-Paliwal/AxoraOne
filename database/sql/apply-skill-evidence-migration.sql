-- Apply Skill Evidence Migration
-- This creates the skill_evidence table for linking pages to skills
...
CREATE INDEX IF NOT EXISTS idx_skill_evidence_page_id ON public.skill_evidence(page_id);
CREATE INDEX IF NOT EXISTS idx_skill_evidence_user_id ON public.skill_evidence(user_id);

-- Verify the table was created
SELECT 'Skill evidence table created successfully!' as status;
